    ...
    return (
        <div className="flex items-center justify-between p-4 bg-gray-100 rounded-lg shadow-sm">
            ...
            <div className="flex space-x-2">
                <button className="bg-gray-800 hover:bg-gray-700 hover:cursor-pointer text-white px-4 py-2 rounded-lg" onClick={onEdit}>Edit</button>
                <button className="bg-red-600 hover:bg-red-500 hover:cursor-pointer text-white px-4 py-2 rounded-lg" onClick={onDelete}>Delete</button>
            </div>
        </div>
    );
}